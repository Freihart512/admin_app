...
export abstract class ValueObject<T, V> {
  protected constructor(protected readonly value: T, validator?: V) {
    this.ensureIsValid(value, validator);
  }

  // Subclases deben implementar su propia validación
  protected abstract ensureIsValid(value: T, validator?: V): void;
