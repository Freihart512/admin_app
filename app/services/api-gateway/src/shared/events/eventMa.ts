...
import { UserLoginFailedEvent, UserLoginFailedPayload } from './authentication/UserLoginFailedEvent';
import { HandlerExecutionFailedEvent, HandlerExecutionFailedPayload } from './application/HandlerExecutionFailedEvent';
import { ApplicationErrorEvent, ApplicationErrorPayload } from './application/ApplicationErrorEvent'; // Inclúyelo si decides mantenerlo definido
...
export interface EventMap {
  ...
  'HandlerExecutionFailedEvent': IDomainEvent<'HandlerExecutionFailedEvent', HandlerExecutionFailedPayload>;
